...
export const messages: Record<Locale, Tree> = {
  en: {
    ...
    home: {
      heroTitle: "Send, save, and reach 10 countries.",
      heroCopy: "One XAF wallet with an @handle. Send to MTN and Orange, save daily, weekly or monthly with a penalty that keeps you honest, and pay people in Nigeria, Ghana, Senegal and across CEMAC.",
      heroPill: "New: savings pots and transfers across Africa",
    ...
    auth: {
      ...
      codeSentSignup: "We sent a 6-digit code. If you do not see it, check spam/junk too.",
      ...
      verifySubtitle: "We sent a 6-digit code to {email}. If it is missing, check spam/junk too.",
  ...
  fr: {
    ...
    home: {
      heroTitle: "Envoyez, épargnez, touchez 10 pays.",
      heroCopy: "Un portefeuille XAF avec un @identifiant. Envoyez vers MTN et Orange, épargnez chaque jour, semaine ou mois avec une pénalité qui vous garde discipliné, et payez au Nigeria, au Ghana, au Sénégal et dans toute la CEMAC.",
      heroPill: "Nouveau : cagnottes d'épargne et transferts en Afrique",
    ...
    auth: {
      ...
      codeSentSignup: "Nous avons envoyé un code à 6 chiffres. S'il n'apparaît pas, vérifiez aussi vos spams.",
      ...
      verifySubtitle: "Nous avons envoyé un code à 6 chiffres à {email}. S'il n'apparaît pas, vérifiez aussi vos spams.",
