...
const products = [
  ...
  },
  {
    icon: Store,
    title: "Business",
    copy: "One checkout for MTN, Orange, cards, and wallet. Payment links and QR included.",
  ...
  },
  {
    icon: Code2,
    title: "Developers",
    copy: "A payments API for your app. Collect, pay out, and get webhooks in Cameroon.",
